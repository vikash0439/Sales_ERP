...
<h6 style="padding-right: 50px; " align="right"><span class="fa fa-universal-access"></span><b>  Welcome <%=session.getAttribute("bdename") %> </b>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="dwr">Add Lead</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href="<c:url value='/logout'/>">Logout</a></h6>
</div>
<br>
<center>	
<h4 align="center">Daily Work Report</h4>
<display:table cellpadding="10" cellspacing="0" id="client" class="table table-striped table-bordered" style="width:100%" name="client"  export="false">

	<display:column property="id" title="Id No" sortable="false" />
	<display:column property="date" title="Date & Time" sortable="false" />
	<display:column property="name" title="Name" href="editlead" paramId="id" paramProperty="id" sortable="false" />
